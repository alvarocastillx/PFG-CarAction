...
@Composable
private fun CurrentChatsScreenPreview() {
    MaterialTheme {
        RelayContainer {
            CurrentChatsScreen(
                leftMenuClick = {},
...
fun Vector(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.current_chats_screen_vector),
...
fun Chats(modifier: Modifier = Modifier) {
    RelayText(
        ...
        maxLines = -1,
        modifier = modifier.requiredWidth(106.0.dp).requiredHeight(33.0.dp)
    )
}
...
fun Linea1(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.current_chats_screen_linea1),
